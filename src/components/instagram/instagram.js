...
const Instagram = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row w-full bg-orange-100 p-5 rounded-lg my-6'>
      ...
      <div className="flex flex-wrap items-center justify-center lg:-mb-16 w-full lg:max-w-xs">
        {new Array(4).fill(undefined).map((_, i) => {
          if (!images) {
            return (
              <div key={`ig-loading-${i}`} className='w-32 h-32 rounded bg-gray-100 mr-4 mb-4' />
            )
          }
